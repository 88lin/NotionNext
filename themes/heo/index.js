...
const LayoutSlug = props => {
  ...
  return (
    <>
      <div
        className={`article h-full w-full ${fullWidth ? '' : 'xl:max-w-5xl'} ${hasCode ? 'xl:w-[73.15vw]' : ''}  bg-white dark:bg-[#17191d] dark:border-gray-600 lg:hover:shadow lg:border rounded-3xl lg:px-2 lg:py-4 `}>
        {/* 文章锁 */}
