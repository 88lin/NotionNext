...
const BLOG = {
  ...
  NEXT_REVALIDATE_SECOND: process.env.NEXT_PUBLIC_REVALIDATE_SECOND || 60480, // 更新内容缓存间隔 单位(秒)；即每个页面有5秒的纯静态期、此期间无论多少次访问都不会抓取notion数据；调大该值有助于节省Vercel资源、同时提升访问速率，但也会使文章更新有延迟。
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个大学牲, Hi，我是一个打工人,Hi，我是一个干饭人,欢迎来到我的博客🎉',
  ...
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || 'https://jsd.cdn.zzko.cn/gh/88lin/PicX@master/___4.2bea6j7kevtw.svg', // blog favicon 配置, 默认使用 /favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  ...
  PRISM_THEME_PREFIX_PATH:
    ...
    'https://jsd.cdn.zzko.cn/npm/prismjs@1.29.0/themes/prism-holi-theme.min.css', // 代码块默认主题
  ...
  // Mermaid 图表CDN
  MERMAID_CDN:
    process.env.NEXT_PUBLIC_MERMAID_CDN || 'https://jsd.cdn.zzko.cn/npm/mermaid@10.9.0/dist/mermaid.min.js', // CDN
  // QRCodeCDN
  QR_CODE_CDN:
    process.env.NEXT_PUBLIC_QR_CODE_CDN || 'https://jsd.cdn.zzko.cn/npm/qrcodejs@1.0.0/qrcode.min.js',
  ...
  // 烟花色彩
  FIREWORKS_COLOR: ['255,182,185', '250,227,217', '187,222,214', '138,198,209'],
  ...
  COMMENT_GITALK_JS_CDN_URL:
    process.env.NEXT_PUBLIC_COMMENT_GITALK_JS_CDN_URL || 'https://jsd.cdn.zzko.cn/npm/gitalk@1/dist/gitalk.min.js', // gitalk客户端 js cdn
  COMMENT_GITALK_CSS_CDN_URL:
    process.env.NEXT_PUBLIC_COMMENT_GITALK_CSS_CDN_URL || 'https://jsd.cdn.zzko.cn/npm/gitalk@1/dist/gitalk.css', // gitalk客户端 css cdn
  ...
  SEO_BAIDU_SITE_VERIFICATION: process.env.NEXT_PUBLIC_SEO_BAIDU_SITE_VERIFICATION || 'codeva-bBW3o4leNz', // 百度站长平台的站点验证
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || '故人博客', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  ...
  DESCRIPTION: process.env.NEXT_PUBLIC_DESCRIPTION || '记录生活，分享资源', // 站点描述，被notion中的页面描述覆盖
