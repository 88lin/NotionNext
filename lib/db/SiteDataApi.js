...
function getSiteInfo({ collection, block, rawMetadata, NOTION_CONFIG }) {
  ...
  const defaultPageCover = NOTION_CONFIG?.HOME_BANNER_IMAGE || 'https://cdn.jsdmirror.com/gh/88lin/picx-images-hosting@master/bg-image.jpg'
  const defaultIcon = NOTION_CONFIG?.AVATAR || '/favicon.svg'
